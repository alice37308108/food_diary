...
urlpatterns = [
    ...
    path('actions/<int:action_id>/edit/', views.edit_action, name='edit_action'),  # アクション編集
    path('actions/<int:action_id>/delete/', views.delete_action, name='delete_action'),  # アクション削除
